...
exports.customQuestionMessage = function(title, imageUrl, choiceTexts, nextQuestionId) {
  return {
    "type": "flex",
    "altText": "this is a flex message",
    "contents": customFunc(title, imageUrl, choiceTexts, nextQuestionId)
  }
}
...
function customFunc(title, imageUrl, choiceTexts, nextQuestionId) {
  return {
    "type": "bubble",
    // "hero": {
    //   "type": "image",
